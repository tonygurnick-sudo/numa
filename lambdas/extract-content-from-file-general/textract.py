...
def get_text_from_document(bucket: str, key: str) -> str:
    ...
    # Convert to string with format Title:/nPage 1:/n{text}/nPage 2:/n{text} etc
    document_string = ""
    document_string += f"Title: {document.name}\n\n"
    for page in document.text:
        document_string += f"Page {page.page_number}:\n{page.text}\n"
