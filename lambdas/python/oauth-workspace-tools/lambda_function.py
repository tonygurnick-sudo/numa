...
OAUTH_TOOL_HANDLERS: Dict[str, Callable[[Dict[str, Any]], Dict[str, Any]]] = {
    ...
    "connect_synergy_job_meta": handle_connect_synergy_job_meta,
    "connect_synergy_folder_summary": handle_connect_synergy_folder_summary,
    "connect_synergy_schema": handle_connect_synergy_schema,
    "connect_synergy_file_info": handle_connect_synergy_file_info,
    "connect_synergy_job_stats": handle_connect_synergy_job_stats,
    "connect_synergy_job_tree": handle_connect_synergy_job_tree,
    "connect_synergy_portfolio": handle_connect_synergy_portfolio,
    "connect_synergy_exact_term": handle_connect_synergy_exact_term,
    # Synergy read-tools Wave 1 (read-only, PAT-scoped, no Numa ACL, no metering)
    "connect_synergy_tasks": handle_connect_synergy_tasks,
    "connect_synergy_contacts": handle_connect_synergy_contacts,
    "connect_synergy_issues": handle_connect_synergy_issues,
    "connect_synergy_workflow": handle_connect_synergy_workflow,
    "connect_synergy_file_history": handle_connect_synergy_file_history,
    "connect_synergy_recent": handle_connect_synergy_recent,
    # Synergy read-tools Wave 2 (read-only, PAT-scoped, no Numa ACL, no metering)
    "connect_synergy_forums": handle_connect_synergy_forums,
    "connect_synergy_projects": handle_connect_synergy_projects,
    "connect_synergy_transmittals": handle_connect_synergy_transmittals,
    "connect_synergy_companies": handle_connect_synergy_companies,
    "connect_synergy_webforms": handle_connect_synergy_webforms,
    "connect_synergy_job_extras": handle_connect_synergy_job_extras,
    "connect_synergy_notes": handle_connect_synergy_notes,
    "connect_synergy_status": handle_connect_synergy_status,
    "connect_synergy_users": handle_connect_synergy_users,
