...
function showSummaryTab(id) {
  document.querySelectorAll('.summary-tab-content').forEach((t) => (t.style.display = 'none'));
  document.getElementById(id).style.display = 'block';
  document.querySelectorAll('.summary-tab-label').forEach((l) => l.classList.remove('active'));
...
function updateTotalErrorsChart(filterType) {
  ...
  chart.update();
  document.querySelectorAll('.total-filter-button').forEach((b) => b.classList.remove('active'));
  document.getElementById('total-' + filterType + '-filter').classList.add('active');
}
...
function updateUniqueErrorsChart(filterType) {
  ...
  chart.data.datasets = ds;
  chart.update();
  document.querySelectorAll('.unique-filter-button').forEach((b) => b.classList.remove('active'));
  document.getElementById('unique-' + filterType + '-filter').classList.add('active');
}
