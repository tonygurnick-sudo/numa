"""
Main implementation for the Data Analysis Claude Code Agent.

This agent specializes in data analysis, visualization, and document processing
with enhanced capabilities for working with pandas, plotly, and various file formats.
"""
...
def run(event: Dict[str, Any], context: LambdaContext) -> Dict[str, Any]:
    ...
    Handles the complete lifecycle of a data analysis task:
    1. Setup workspace and hydrate inputs
    2. Restore session if resuming
    3. Run Claude CLI with data analysis prompts
    ...
    final_prompt, inc_count, extra_count = workspace.augment_prompt_with_uploads(
        user_prompt, dirs["inputs"], include=augment_uploads
    )
    if inc_count:
        logger.info(
...
# =============================================================================
# DATA ANALYSIS SPECIFIC FUNCTIONS
# =============================================================================
