...
Your default AWS profile must be access keys for the Arcanum Prod AWS account. We use the SDK to assume a role into the Customer Account via the trust relationship defined in the Customer Account.
