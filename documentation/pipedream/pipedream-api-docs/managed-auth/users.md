...
For complete API details including TypeScript and Node.js examples, [refer to the API reference](/connect/api-reference/delete-account).
...
For complete API details including TypeScript and Node.js examples, see the [API reference](/connect/api-reference/delete-external-user).
