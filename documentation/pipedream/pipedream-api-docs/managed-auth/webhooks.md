...
Please note that user credentials are not sent in the webhook request. To retrieve credentials, use the [Connect API to fetch the account](/connect/api-reference/retrieve-account) using the `account.id` provided in the webhook payload.
