...
| **In-client view**             | `numa-frontend/src/Components/Settings/CreditsDashboard/`                                                                                              | Settings → Credits tab (gated by `SHOW_CREDITS`).                                                                                                           |
...
| [08-open-questions.md](08-open-questions.md)           | Decided-but-not-built and genuinely-open items: the allocation=0 onboarding policy, the classifier value-signal fix, reference pricing bands, the billing-admin role, measured AgentCore-seconds, monthly reconciliation.                   |
