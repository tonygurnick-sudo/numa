...
| value tiers (chat)         | 2/4/8/18         | `tiers.py: VALUE_TIER_CREDITS.chat`      | `DEFAULT_CONFIG.valueTiers.chat`                  | `DEFAULT_CREDIT_CONFIG.valueTiers.chat`                             |
| value tiers (agent)        | 2/3/5/12         | `tiers.py: VALUE_TIER_CREDITS.agent`     | `DEFAULT_CONFIG.valueTiers.agent`                 | `DEFAULT_CREDIT_CONFIG.valueTiers.agent`                            |
| margins (defence)          | 1.15/1.3/1.6/2.0 | `credits.py: MARGINS_BY_TIER`            | `DEFAULT_CONFIG.marginsByTier`                    | `DEFAULT_CREDIT_CONFIG.marginsByTier`                               |
