...
> instances. If you choose SAML identity management, the federated agent user is
> `numa-voice-agent` (see `AGENT_USERNAME`). Embedded CCP login is Chrome/Edge only
