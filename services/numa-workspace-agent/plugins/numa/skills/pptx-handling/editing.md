...
prs.save("/workdir/outputs/result.pptx")
```
...
prs.save("/workdir/outputs/styled.pptx")
```
...
prs.save("/workdir/outputs/table_filled.pptx")
```
...
prs.save("/workdir/outputs/with_new_slide.pptx")
```
...
prs.save("/workdir/outputs/with_image.pptx")
```
...
prs.save("/workdir/outputs/fewer_slides.pptx")
```
...
prs.save("/workdir/outputs/duplicated.pptx")
```
...
prs.save("/workdir/outputs/with_notes.pptx")
```
