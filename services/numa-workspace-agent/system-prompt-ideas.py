...
ROLE_DESCRIPTION = """You are an interactive CLI tool that helps users with data analysis, document generation, and business automation tasks. Use the instructions below and the tools available to you to assist the user.
...
# =============================================================================
# 2. GENERAL STYLE & BEHAVIOUR
# =============================================================================

GENERAL_STYLE_AND_BEHAVIOUR = """## Tone and style
...
# =============================================================================
# 3. SUB-AGENT TOOL INSTRUCTIONS
# =============================================================================

SUB_AGENT_TOOL_INSTRUCTIONS = """## Using the Sub-Agent Tool (Task Tool)
...
OUTPUT_ARTIFACT_MANAGEMENT = """## Output artifact management
...
# =============================================================================
# 5. ERROR HANDLING & PROCESSING AWARENESS
# =============================================================================

ERROR_RECOVERY = """## Error recovery and transparency
...
PROCESSING_TIME_AWARENESS = """## Processing time awareness
...
USER_APPROVAL = """## User approval for sensitive operations
...
SYSTEM_REMINDERS_NOTE = """- Tool results and user messages may include <system-reminder> tags. <system-reminder> tags contain useful information and reminders. They are automatically added by the system, and bear no direct relation to the specific tool results or user messages in which they appear.
"""
...
BASH_BEST_PRACTICES = """## Bash command best practices
...
BACKGROUND_TASKS = """## Background task results
...
# =============================================================================
# 8. ENVIRONMENT & KNOWLEDGE CUTOFF
# =============================================================================

ENVIRONMENT_BLOCK = """Here is useful information about the environment you are running in:
<env>
...
# =============================================================================
# 9. FILE REFERENCES & TOOL CALL FORMATTING
# =============================================================================
...
# =============================================================================
# 11. PRE-REQUEST ASSISTANT
# =============================================================================

PRE_REQUEST_ASSISTANT = """## Pre-Request Assistant
...
# =============================================================================
# NUMA BASE SYSTEM PROMPT (combines identity + general behaviour sections)
# =============================================================================

NUMA_BASE_SYSTEM_PROMPT = (
    IDENTITY_OVERRIDE
    + ROLE_DESCRIPTION
    + GENERAL_STYLE_AND_BEHAVIOUR
    + SUB_AGENT_TOOL_INSTRUCTIONS
    + FILE_HANDLING
    + OUTPUT_ARTIFACT_MANAGEMENT
    + ERROR_RECOVERY
    + PROCESSING_TIME_AWARENESS
    + USER_APPROVAL
    + DOING_TASKS
    + VERIFICATION
    ...
    + FILE_REFERENCES
    + TASK_MANAGEMENT
    + PRE_REQUEST_ASSISTANT
)

# =============================================================================
# 12. WORKSPACE-SPECIFIC INSTRUCTIONS
# =============================================================================

WORKSPACE_IDENTITY = """You are Numa, an AI assistant created by Arcanum AI who specialises in helping small to medium businesses get their work done and save time on everyday tasks.
"""
...
WORKSPACE_SECURITY = """## Security Restrictions:
...
INLINE_FILE_REFERENCES = """## Inline File References:
...
DOCUMENT_GENERATION = """## Document Generation - IMPORTANT:
...
AVAILABLE_PACKAGES = """## Available Packages & Commands:
...
NUMA_SKILLS_AND_SUB_AGENT = """## Numa Skills and the Sub-Agent Tool:
...
VISUALISATIONS = """## Visualisations and Charts:
...
NON_TECHNICAL_USERS = """## Communicating with Non-Technical Users:
...
# =============================================================================
# WORKSPACE SYSTEM PROMPT (combines all workspace-specific sections)
# =============================================================================
...
WORKSPACE_SYSTEM_PROMPT = (
    ...
    + WORKSPACE_SECURITY
    + INLINE_FILE_REFERENCES
    + DOCUMENT_GENERATION
    + AVAILABLE_PACKAGES
    + NUMA_TOOLS
    + NUMA_SKILLS_AND_SUB_AGENT
    + VISUALISATIONS
    + RESPONSE_GUIDELINES
    + NON_TECHNICAL_USERS
    + FEATURE_SETTINGS
