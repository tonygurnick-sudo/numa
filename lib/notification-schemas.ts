...
export const EventNotificationSchema = z.object({
  ...
  event_type: z.enum(['started', 'completed', 'partial', 'failed', 'cancelled', 'new_event']),
  schedule_type: z.enum(['agent', 'application', 'data_sync', 'transcription', 'connector', 'voice_call']),
