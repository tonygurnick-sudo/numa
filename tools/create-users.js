...
export async function createQUsers(credentials, userPool, qUrl, dryRun) {
...
async function createQUser(client, qUrl, userDetails, userPool) {
  try {
    await client.send(
...
async function activateQLicence(qUrl, username, password) {
