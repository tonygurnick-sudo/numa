...
async function sign(credentials, method, url, service, region, body) {
  region ??= 'us-east-1';
...
async function listSubscriptions(credentials, applicationId) {
...
async function setSubscription(credentials, applicationId, subscriptionId) {
  const url = new URL(
...
async function deleteSubscription(credentials, applicationId, subscriptionId) {
...
async function getCognitoUserEmail(client, userPool, userArn) {
