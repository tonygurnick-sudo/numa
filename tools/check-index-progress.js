...
async function listDataSources(credentials, applicationId, indexId) {
...
async function findSyncJobs(credentials, applicationId, indexId, dataSourceId) {
  const qbusiness = new QBusinessClient({ region, credentials });
  const response = await qbusiness.send(
...
async function startSync(credentials, applicationId, indexId, dataSourceId) {
  const qbusiness = new QBusinessClient({ region, credentials });
