...
| `documentation/self-optimising-numa.md` | Self-Optimising Numa (FEAT-243): the compounding pattern — scheduled agents reflect and script deterministic steps / save memories; chat actively saves workflows + memories; agent-scoped workflow library; "script mechanics, never judgment". Read before adding any agent execution surface.    |
