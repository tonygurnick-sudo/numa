...
describe('ResetPassword Component', () => {
  ...
  it('should render initial password reset request form', () => {
    ...
    expect(
      screen.getByRole('heading', { name: 'Request Password Reset' }),
    ).toBeInTheDocument();
  ...
  it('should handle password reset request submission', async () => {
    ...
    expect(authHandlers.requestPasswordReset).toHaveBeenCalledWith(
      'test@example.com',
    );
  });

  it('should handle password reset request error', async () => {
    authHandlers.requestPasswordReset.mockRejectedValueOnce(
  ...
  it('should handle password reset confirmation', async () => {
    ...
    await waitFor(() => {
      expect(authHandlers.confirmPasswordReset).toHaveBeenCalledWith(
        'test@example.com',
        '123456',
        'newpassword',
      );
