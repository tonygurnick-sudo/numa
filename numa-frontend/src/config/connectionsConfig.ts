...
// import smartsheetIcon from '../assets/icons/smartsheet.png';
// import airtableIcon from '../assets/icons/airtable.png';
// import ringcentralIcon from '../assets/icons/ringcentral.png';
...
export const CONNECTIONS_CONFIG: Record<string, ConnectionConfigEntry> = {
  ...
  //   id: 'smartsheet',
  //   name: 'Smartsheet',
  //   description: 'Manage projects, track tasks, and collaborate on work management',
  //   auth_type: 'oauth',
  //   img_src: smartsheetIcon,
  //   fallback_icon: 'bi bi-table',
  //   fallback_color: 'info',
  //   example_query: 'List my recent project updates',
  // },
  // airtable_oauth: {
  //   id: 'airtable_oauth',
  //   name: 'Airtable',
  //   description: 'Access databases, create records, and manage structured data',
  //   auth_type: 'oauth',
  //   img_src: airtableIcon,
  //   fallback_icon: 'bi bi-grid-3x3',
  //   fallback_color: 'warning',
  //   example_query: 'Show records from my main database',
  // },
  // ringcentral: {
  //   id: 'ringcentral',
  //   name: 'RingCentral',
  //   description: 'Make calls, send SMS, manage contacts, and automate communication workflows',
  //   auth_type: 'oauth',
  //   img_src: ringcentralIcon,
  //   fallback_icon: 'bi bi-telephone',
  //   fallback_color: 'primary',
  //   example_query: 'Show my recent call history',
  // },
  // linkedin: {
  //   id: 'linkedin',
  //   name: 'LinkedIn',
  ...
  //   id: 'webflow',
  //   name: 'Webflow',
  //   description: 'Manage your Webflow CMS, create collection items, and automate website content workflows',
  //   auth_type: 'oauth',
  //   img_src: webflowIcon,
  //   fallback_icon: 'bi bi-globe2',
  //   fallback_color: 'primary',
  //   example_query: 'Show me my recent collection items and site updates',
  // },
  // sharepoint: {
  //   id: 'sharepoint',
