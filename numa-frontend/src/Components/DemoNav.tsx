...
const MAIN_ENTRIES: DemoNavEntry[] = [
  ...
  { kind: 'section', sectionKey: 'nav.sections.knowledgeBases', fallback: 'Numa Files' },
  { kind: 'item', labelKey: 'nav.items.companyKnowledgeBase', fallback: 'Company Files', Icon: Building2 },
  { kind: 'item', labelKey: 'nav.items.userKnowledgeBase', fallback: 'My Folders', Icon: UserRound },
