...
import type { Supplier, Activity, Document as OpsDocument, UpdateSupplierPayload } from '../../../types/ops';
          ...
          <Accordion defaultActiveKey={['0', '1']} alwaysOpen>
            ...
            <Accordion.Item eventKey="5">
              ...
              <Accordion.Body>
                {linkedTicketCount > 0 ? (
                  <div className="small">
                    {linkedTicketCount} {t('crm.linkedWork')}
                  </div>
                ) : (
